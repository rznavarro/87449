...
Quedo atenta a su respuesta para coordinar la cita. ¡Gracias!`;
  ...
  const whyChooseUs = useMemo(() => [
    ...
    },
    {
      ...
      description: "Enfoque individual y cercano, especialmente para mujeres jóvenes"
    },
    {
    ...
    },
    {
      ...
      description: "Martes 8:30-12:30, adaptándonos a tu rutina"
    }
  ], []);
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Matrona Yaritza Núñez - Matrona Ginecóloga. Todos los derechos reservados.</p>
